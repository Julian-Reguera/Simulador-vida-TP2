...
class ChangeRegionsDialog extends JDialog implements EcoSysObserver {
	...
	private void initGUI() {
		...
		_regionsBox.addActionListener((a)->{actualizaTabla();});
		...
		cancel.addActionListener((a)->{SwingUtilities.invokeLater(()->{this.setVisible(false);});});
		ok.addActionListener((a)->{hacerCambiosModelo();});
	...
	public void onAnimalAdded(double time, MapInfo map, List<AnimalInfo> animals, AnimalInfo a) {
		//mejor no pongoque se actualizen las cosas porque serían muchas actualizaciones innecesarias
		
	}

	@Override
	public void onRegionSet(int row, int col, MapInfo map, RegionInfo r) {
		//mejor no pongo que se actualizen las cosas porque serían muchas actualizaciones innecesarias.
		
	}

	@Override
	public void onAvanced(double time, MapInfo map, List<AnimalInfo> animals, double dt) {
		//mejor no pongo que se actualizen las cosas porque serían muchas actualizaciones
	}
	...
	private void actualizaTabla()
	{
		...
		for(JSONObject o: _regionsInfo)
		{
			...
			{
				if(o.has("data")) infoSeleccion = o.getJSONObject("data");
				break;
			}
		}
