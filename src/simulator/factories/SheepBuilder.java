...
public class SheepBuilder extends Builder<Animal> {
	...
	public SheepBuilder(Factory<SelectionStrategy> strategyBuilder) {
		super("sheep", "Genera objetos de tipo sheep");
	...
	protected void fill_in_data(JSONObject o) {
		...
		// o.put("danger_strategy", _strategyBuilder.get_info());
		o.put("pos", posicion);
	}
	...
	protected Animal create_instance(JSONObject data) {
		...
		SelectionStrategy dangerStrategy = new SelectFirstBuilder.SelectFirst();
		...
		if (data.has("danger_strategy")) {
			dangerStrategy = _strategyBuilder.create_instance(data.getJSONObject("danger_strategy"));
			contador++;
		}
